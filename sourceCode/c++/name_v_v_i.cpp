/**
 * @version 5.1
 *      An exercise, just for the code cleanup... 
 *
 * @version 5.0
...
class Person {
    public:
        ...
        //A member function to display the properties...
        void doTheDisplay() {
            cout << "\n********************************"
                 << "\nYour Name: " << myName
                 << "\nYour Age: " << myAge
                 << "\nAnd Your Favorite Alphabet Is: " << myFavAlphabet << endl;
        }
...
void doTheDisplay(string pName, int pAge, char pFav) {
 ...
 //   allDetails[gCountInt] = myDetails;       //This did not work...
    ...
    allPersons[gCountInt].myName = pName;
    allPersons[gCountInt].myAge = pAge;
    allPersons[gCountInt].myFavAlphabet = pFav;
    ...
    /*cout << "\n********************************"
     ...
     /*cout << "\n********************************"
         << "\nYour Name: " << allPersons[gCountInt].myName
         << "\nYour Age: " << allPersons[gCountInt].myAge
         << "\nAnd Your Favorite Alphabet Is: " << allPersons[gCountInt].myFavAlphabet << endl; */
     allPersons[gCountInt].doTheDisplay();
