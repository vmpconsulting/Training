 ...
 */
 class Shapes {
    ...
    public:
        /**
         * Calling any method, within the class, IRRESPECTIVE OF THE ACCESS MODIFIER, is possible and legal...
         */
        void callAllMethods() {
          describeSelf();
          describeSelf("I'm called from within the class and my access is PRIVATE");   //Calling the PRIVATE method, from within the class itself...
          describeSelf("I'm called from within the class and my access is PROTECTED", "I'm a PROTECTED method");   //Calling the PRIVATE method, from within the class itself...
        }
        

        //virtual void printYourShape() {
        //  cout << "\n\nHi, I'm Shapes" << endl;
        //}
        //A pure virtual function...??? which is an abstract function...
        virtual void printYourShape() = 0;
 };
...
void letsPrintTheShape(Shapes* pShapesPointer) {
    pShapesPointer->printYourShape();
}
